...
const NavbarDesktop = () => {
  ...
  return (
    <nav className="bg-[#f9fcfd] hidden lg:flex justify-between fixed w-full pr-4 z-50 shadow-2xl items-center max-w-screen-sm md:max-screen-md lg:max-w-screen-xl">
      {/* LOGO */}
      <div className="flex">
        <Link href="/">
          <img
